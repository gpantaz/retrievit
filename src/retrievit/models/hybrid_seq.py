...
class MixerModel(nn.Module):
    def __init__(
        ...
        layer_block: nn.Module | None = None,
    ) -> None:
        ...
        blocks = []
        for block_idx, block_type in zip(range(n_layer), layer_block, strict=True):
            if block_type in ["mamba", "mamba2"]:
                blocks.append(
                    create_block(
                        d_model,
                ...
                blocks.append(TransformerDecoderLayer(transformer_config, layer_idx=block_idx))
        ...
        **mixer_kwargs: dict[str, Any],
        ...
        for layer in self.layers:
            ...
            if isinstance(layer, TransformerDecoderLayer):
                layer_outputs, residual_pre_ln, residual_post_attn = layer(
                    hidden_states,
...
class HybridSeq(nn.Module, GenerationMixin):
    def __init__(
        self,
        ...
        self.backbone = MixerModel(
            ...
            layer_block=config.layer_block,
            **factory_kwargs,
        )
